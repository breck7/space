...
Space.prototype.map=function(a,b,c,d){if(!d)return(new Space(this)).map(a,b,c);this._index={};this._cache={};for(var e=this._pairs.length,f=0;f<e;f++)a&&(this._pairs[f][0]=a(this._pairs[f][0])),!(this._pairs[f][1]instanceof Space)&&b?this._pairs[f][1]=b(this._pairs[f][1]):c&&this._pairs[f][1]instanceof Space&&this._pairs[f][1].map(a,b,c,d),this._updateCache(this._pairs[f][0],this._pairs[f][1]);return this};Space.prototype.next=function(a){a=this.indexOf(a)+1;return this._getPropertyByIndex(a)};
