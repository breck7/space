...
Space.prototype.getBySpace=function(a){var b=new Space,d;for(d in a.keys){var c=a.keys[d],e=this.values[c];"undefined"!==typeof e&&(!(a.values[c]instanceof Space)||!a.values[c].keys.length?b.set(c,e):e instanceof Space&&b.set(c,e.getBySpace(a.values[c])))}return b};Space.prototype.length=function(){return this.keys.length};
