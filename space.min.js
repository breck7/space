...
Space.prototype._getValueByProperty=function(a){var b;this._pairs.forEach(function(c){if(c[0]===a)return b=c[1],!1});return b};Space.prototype._getPropertyByIndex=function(a){0>a&&(a=this.length()+a);return this.getProperties()[a]};Space.prototype.getProperties=function(){var a=[];this._pairs.forEach(function(b){a.push(b[0])});return a};
Space.prototype._getValueByString=function(a){if(a){if(!a.match(/ /))return this._getValueByProperty(a);a=a.split(/ /g);var b=a.shift();if(this.has(b)&&this._getValueByProperty(b)instanceof Space)return this._getValueByProperty(b).get(a.join(" "))}};
...
Space.prototype.getTokensConcise=function(){return this.getTokens().replace(/[^\w\s]|(.)(?=\1)/gi,"")};Space.prototype.getValues=function(){var a=[];this._pairs.forEach(function(b){a.push(b[1])});return a};Space.prototype.has=function(a){return void 0!==this._getValueByProperty(a)};Space.prototype.__height=function(){return this.toString().match(/\n/g).length};Space.prototype.indexOf=function(a){return this.getProperties().indexOf(a)};Space.prototype.insert=function(a,b,c){this._setPair(a,b,c);return this};
...
Space.prototype._setByXPath=function(a,b){if(!a)return null;for(var c=a.toString().split(/ /g),d=this,e,f,h=0;h<c.length;h++){e=c[h];if((f=h===c.length-1)||!(d._getValueByProperty(e)instanceof Space)){var g;g=f?b:new Space;d.has(e)?(f=d.indexOf(e),d._setPair(e,g,f,!0)):d._setPair(e,g)}d=d.get(e)}return this};Space.prototype._setPair=function(a,b,c,d){a=a.toString();void 0===c?this._pairs.push([a,b]):d?this._pairs.splice(c,1,[a,b]):this._pairs.splice(c,0,[a,b])};
Space.prototype.shift=function(){if(!this.length())return null;var a=this._getPropertyByIndex(0),b=new Space;b.set(a,this.get(a));this._delete(a);return b};Space.prototype.sort=function(a){this._pairs=this._pairs.sort(a);return this};Space.prototype.tableOfContents=function(){return this.getProperties().join(" ")};
