...
Space.prototype.isASet=function(){var a=!0,b={};this.each(function(c,d){if(b[c])return a=!1;b[c]=!0;if(d instanceof Space)return d.isASet()?!0:a=!1});return a};Space.prototype._typeCount=function(){var a=this.length();this.each(function(b,c){c instanceof Space&&(a+=c._typeCount())});return a};Space.prototype.length=function(){return this.getTypes().length};
...
Space.prototype._setByXPath=function(a,b){if(!a)return null;for(var c=a.toString().split(/ /g),d=this,e,f,h=0;h<c.length;h++){e=c[h];if(!(d._getValueByType(e)instanceof Space)){var g;g=h===c.length-1?b:new Space;d.has(e)?(f=d.indexOf(e),d._setPair(e,g,f,!0)):d._setPair(e,g)}d=d.get(e)}return this};Space.prototype._setPair=function(a,b,c,d){a=a.toString();void 0===c?this._pairs.push([a,b]):d?this._pairs.splice(c,1,[a,b]):this._pairs.splice(c,0,[a,b])};
