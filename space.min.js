function Space(a){this._pairs=[];this._propertyCounts={};this._cache={};this._load(a);return this}Space.version="0.9.15";Space.removeItems=function(a,b){var c=[];"number"===typeof b&&(b=[b]);for(var d=b.length-1;0<=d;d--)c.push(a.splice(b[d],1));return c};Space.isXPath=function(a){return a.match(/ /)};
...
Space.prototype.each=function(a,b){for(var c=this._pairs.length,d=0;d<c&&!(b&&this._pairs[d][1]instanceof Space&&this._pairs[d][1].each(a,b),!1===a.call(this,this._pairs[d][0],this._pairs[d][1],d));d++);return this};Object.defineProperty(Space.prototype,"events",{get:function(){return this._events||{}}});Space.prototype.every=function(a){this.each(function(b,c,d){a.call(this,b,c,d);c instanceof Space&&c.every(a)});return this};
...
Space.prototype.lastValue=function(){return!this.length?null:this._pairs[this.length-1][1]};Object.defineProperty(Space.prototype,"length",{get:function(){return this._pairs.length}});Space._load2=!0;
