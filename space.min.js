function Space(a){this._properties=[];this._values=[];this._cache={};return this._load(a)}Space.version="0.12.1";Space.removeItems=function(a,b){var c=[];"number"===typeof b&&(b=[b]);for(var d=b.length-1;0<=d;d--)c.push(a.splice(b[d],1));return c};Space.isSpacePath=function(a){return a.match(/ /)};
...
Space.prototype._deleteByIndex=function(a){if(void 0===this._properties[a])return 0;var b=this._properties.splice(a,1)[0];this._values.splice(a,1)[0]===this._cache[b]&&this._updateCacheForProperty(b);return 1};Space.prototype._deleteByProperty=function(a){a=this.indexOf(a);return-1===a?0:this._deleteByIndex(a)};Space.prototype._deleteBySpacePath=function(a){var b=a.split(/ /);a=b.pop();b=this.get(b.join(" "));return b instanceof Space?b._delete(a):0};
...
Space.prototype.getByIndex=function(a){return this._getValueByIndex(a)};Space.prototype.getBySpace=function(a){return this._getValueBySpace(a)};Space.prototype.getCud=function(a){var b=new Space("created\nupdated\ndeleted\n"),c=this;a instanceof Space||(a=new Space(a));a.each(function(a,e){void 0===c.get(a)?b.set("created "+a,e):c.get(a).toString()!==e.toString()&&b.set("updated "+a,e)});this.each(function(c){void 0===a.get(c)&&b.set("deleted "+c,new Space)});return b};
Space.prototype._getValueByIndex=function(a){0>a&&(a=this.length+a);return this._values[a]};Space.prototype._getValueByProperty=function(a){return this._cache[a]};Space.prototype._getPropertyByIndex=function(a){var b=this.length;0>a&&(a=b+a);return a>=b?void 0:this._properties[a]};Space.prototype.getProperties=function(){return this._properties.slice(0)};
...
Space.prototype.lastIndexOf=function(a){if(void 0===this._cache[a])return-1;for(var b=this.length-1;0<b;b--)if(this._properties[b]===a)return b;return-1};Space.prototype.lastProperty=function(){return!this.length?null:this._properties[this.length-1]};Space.prototype.lastValue=function(){return!this.length?null:this._values[this.length-1]};Object.defineProperty(Space.prototype,"length",{get:function(){return this._properties.length}});Space._load2=!0;
Space.prototype._load=function(a,b){if(!a)return this;if("string"===typeof a)return!a.length?this:Space._load2?this._loadFromString2(a):this._loadFromString(a);if(a instanceof Space){var c=this;a.each(function(a,b){b instanceof Space?c._setPair(a,b.clone()):c._setPair(a,b)});return this}if(a instanceof Date||"function"===typeof a)return this._load(a.toString());b||(b=[a]);return this._loadFromObject(a,b)};
...
Space.prototype.set=function(a,b,c,d){a=a.toString();Space.isSpacePath(a)?this._setBySpacePath(a,b):c?this._setPair(a,b,c):this.has(a)?this._setPair(a,b,this.indexOf(a),!0):this._setPair(a,b);d||this.trigger("set",a,b,c).trigger("change");return this};
Space.prototype._setBySpacePath=function(a,b){if(!a)return null;for(var c=a.toString().split(/ /g),d=this,e,f,g,h=c.length,j=0;j<h;j++){e=c[j];if((f=j===c.length-1)||!(d._getValueByProperty(e)instanceof Space))g=f?b:new Space,d.has(e)?(f=d.indexOf(e),d._setPair(e,g,f,!0)):d._setPair(e,g);d=d.get(e)}return this};
Space.prototype._setPair=function(a,b,c,d){var e=this.length;"string"!==typeof b&&!(b instanceof Space)&&(b=String(b));a=a.toString();if(void 0===c)this._properties.push(a),this._values.push(b);else if(d&&0<=c&&c<e){d=this._properties[c];var e=this._values[c],f=this._cache[d];this._properties[c]=a;this._values[c]=b;e===f&&this._updateCacheForProperty(d)}else c>=e?(this._properties.push(a),this._values.push(b)):(this._properties.splice(c,0,a),this._values.splice(c,0,b));this._updateCache(a,b,c)};
Space.prototype._updateCache=function(a,b,c){var d=this._cache[a];if(void 0===d||null===d)this._cache[a]=b;else if(void 0===c)this._cache[a]=b;else if(d!==b){for(d=this.length-1;d>c&&this._properties[d]!==a;d--);d===c&&(this._cache[a]=b)}};Space.prototype._updateCacheForProperty=function(a){delete this._cache[a];for(var b=this.length;0<=b;b--)if(this._properties[b]===a){this._cache[a]=this._values[b];break}};
Space.prototype._reindex=function(){var a=this.length;this._cache={};for(var b=0;b<a;b++)this._updateCache(this._properties[b],this._values[b],b)};Space.prototype.shift=function(){if(!this.length)return null;var a=this._getPropertyByIndex(0),b=new Space;b.set(a,this.get(a));this._deleteByIndex(0);return b};
...
Space.prototype.toQueryString=function(){var a="",b="";this.each(function(c,d){a+=b+encodeURIComponent(c)+"="+encodeURIComponent(d);b="&"});return a};Space.prototype.toSsv=function(){return this.toDelimited(" ")};Space.prototype.toString=function(a){a=a||0;for(var b="",c=this.length,d=0;d<c;d++)b+=Space._pairToString(this._properties[d],this._values[d],a);return b};Space.prototype.toTsv=function(){return this.toDelimited("\t")};Space.prototype.toURL=function(){return encodeURIComponent(this.toString())};
