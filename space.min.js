...
Space.prototype.diff=function(a){var b=new Space;a instanceof Space||(a=new Space(a));for(var d in this.keys){var c=this.keys[d],e=a.values[c];"undefined"===typeof e?b.set(c,""):typeof this.values[c]!==typeof e?"object"===typeof e?b.set(c,new Space(e)):this.values[c]!=e&&b.set(c,e):"object"!==typeof this.values[c]?this.values[c]!=e&&b.set(c,e):(e=this.values[c].diff(e),e.keys.length&&b.set(c,e))}for(d in a.keys)c=a.keys[d],e=a.values[c],this.values[c]||("object"!==typeof e?b.set(c,e):e instanceof
Space?b.set(c,new Space(e)):b.set(c,new Space(a)));return b};Space.prototype.diffOrder=function(a){a instanceof Space||(a=new Space(a));var b=new Space,d;for(d in a.keys){var c=a.keys[d],e=a.values[c];e instanceof Space&&this.values[c]instanceof Space&&(e=this.values[c].diffOrder(e),e.empty()||b.set(c,e))}if(a.keys.join(" ")===this.keys.join(" "))return b;b.keys=a.keys;for(d in a.keys)c=a.keys[d],b.values.hasOwnProperty(c)||(b.values[c]=new Space);return b};
...
Space.prototype.getByString=function(a){if(!a)return null;if(!a.match(/ /))return this.values[a];a=a.split(/ /g);var b=a.shift();return!(b in this.values)?null:this.values[b].get(a.join(" "))};Space.prototype.getBySpace=function(a){var b=new Space,d;for(d in a.keys){var c=a.keys[d],e=this.values[c];"undefined"!==typeof e&&(!(a.values[c]instanceof Space)||!a.values[c].keys.length?b.set(c,e):e instanceof Space&&b.set(c,e.getBySpace(a.values[c])))}return b};Space.prototype.length=function(){return this.keys.length};
Space.prototype.loadFromString=function(a){a=a.replace(/^[\n ]*/,"");a=a.replace(/\n\r/g,"\n").replace(/\r\n/g,"\n");a=a.replace(/[\n ]*$/,"");a=a.replace(/\n\n+/,"\n");a=a.split(/\n(?! )/g);for(var b in a){var d=a[b];(matches=d.match(/^([^ ]+)(\n|$)/))?this.set(matches[1],new Space(d.substr(matches[1].length).replace(/\n /g,"\n"))):(matches=d.match(/^([^ ]+) /))&&this.set(matches[1],d.substr(matches[1].length+1).replace(/^\n /,"").replace(/\n /g,"\n"))}return this};
Space.prototype.next=function(a){a=this.keys.indexOf(a)+1;return this.keys[a]?this.keys[a]:this.keys[0]};Space.prototype.patch=function(a){a instanceof Space||(a=new Space(a));for(var b in a.keys){var d=a.keys[b],c=a.values[d];if("string"===typeof c)if(""===c)this["delete"](d);else this.set(d,c);else if("number"===typeof c)this.set(d,c);else if(c instanceof Space&&!c.keys.length)this["delete"](d);else this.values[d]instanceof Space?this.values[d].patch(c):this.set(d,new Space(c))}return this};
Space.prototype.patchOrder=function(a){a instanceof Space||(a=new Space(a));var b=this.keys.length,d;for(d in a.keys){var c=a.keys[d];if(!this.values.hasOwnProperty(c))break;b--}0===b&&(this.keys=a.keys);for(d in a.keys)c=a.keys[d],b=a.values[c],b instanceof Space&&(b.keys.length&&this.values[c]instanceof Space)&&this.values[c].patchOrder(b);return this};Space.prototype.prev=function(a){a=this.keys.indexOf(a)-1;return 0<=a?this.keys[a]:this.keys[this.keys.length-1]};
Space.prototype.rename=function(a,b){this.values[b]=this.values[a];delete this.values[a];this.keys[this.keys.indexOf(a)]=b;return this};Space.prototype.set=function(a,b,d){if(!a)return null;a=a.toString().split(/ /g);for(var c=this,e;e=a.shift();)void 0===c.values[e]&&("number"===typeof d?c.keys.splice(d,0,e):c.keys.push(e)),a.length?c.values[e]instanceof Space||(c.values[e]=new Space):c.values[e]=b,c=c.values[e];return this};
