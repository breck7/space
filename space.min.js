function Space(a){this._pairs=[];this.events={};this._load(a);return this}Space.version="0.5.10";Space.arrayDelete=function(a,b){return a.slice(0,b).concat(a.slice(b+1))};Space.isXPath=function(a){return a.match(/ /)};Space.pathBranch=function(a){a=a.split(/ /g);if(2>a.length)return"";a.pop();return a.join(" ")};Space.pathLeaf=function(a){var b=a.split(/ /g);return 2>b.length?a:b[b.length-1]};Space.strRepeat=function(a,b){for(var c="",d=0;d<b;d++)c+=" ";return c};
...
Space.prototype.diff=function(a){var b=new Space;a instanceof Space||(a=new Space(a));this.each(function(c){var e=a._getValueByKey(c);if("undefined"===typeof e)return b._setPair(c,""),!0;if(typeof this._getValueByKey(c)!==typeof e)return"object"===typeof e?b._setPair(c,new Space(e)):this._getValueByKey(c)!=e&&b._setPair(c,e),!0;if("object"!==typeof this._getValueByKey(c))return this._getValueByKey(c)!=e&&b._setPair(c,e),!0;e=this._getValueByKey(c).diff(e);e.length()&&b._setPair(c,e)});var c=this;
