function Space(a){this._properties=[];this._values=[];this._cache={};this._load(a);return this}Space.version="0.11.3";Space.removeItems=function(a,b){var c=[];"number"===typeof b&&(b=[b]);for(var d=b.length-1;0<=d;d--)c.push(a.splice(b[d],1));return c};Space.isXPath=function(a){return a.match(/ /)};
...
Space.prototype._cacheUpdate=function(a){delete this._cache[a];for(var b=this.length;0<=b;b--)if(this._properties[b]===a){this._cache[a]=this._values[b];break}};Space.prototype._deleteByIndex=function(a){if(void 0===this._properties[a])return 0;var b=this._properties.splice(a,1)[0];this._values.splice(a,1)[0]===this._cache[b]&&this._cacheUpdate(b);return 1};Space.prototype._deleteByProperty=function(a){a=this.indexOf(a);return-1===a?0:this._deleteByIndex(a)};
