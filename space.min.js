function Space(a){this.keys=[];this.values={};this.events={};this._load(a);return this}Space.strRepeat=function(a,b){for(var d="",c=0;c<b;c++)d+=" ";return d};Space.union=function(){var a=Space.unionSingle(arguments[0],arguments[1]),b;for(b in arguments)if(1!==b&&(a=Space.unionSingle(a,arguments[b]),!a.keys.length))break;return a};
Space.unionSingle=function(a,b){var d=new Space;if(!(b instanceof Space))return d;for(var c in a.keys){var e=a.keys[c],f=a.values[e];f instanceof Space&&(b.values[e]&&b.values[e]instanceof Space)&&d._set(e,Space.unionSingle(f,b.values[e]));f===b.values[e]&&d._set(e,f)}return d};Space.prototype.keys=[];Space.prototype.values={};Space.prototype._clear=function(){this.keys=[];this.values={};return this};
Space.prototype.clear=function(a){if(this.isEmpty())return this;this._clear();this.trigger("clear");a&&this._load(a);this.trigger("change");return this};Space.prototype.clone=function(){return new Space(this.toString())};Space.prototype._delete=function(a){if(!a.toString().match(/ /)){var b=this.keys.indexOf(a);if(-1===b)return 0;this.keys.splice(b,1);delete this.values[a];return 1}b=a.split(/ /);a=b.pop();b=this.get(b.join(" "));return b instanceof Space?b._delete(a):0};
Space.prototype["delete"]=function(a){this._delete(a)&&this.trigger("delete",a);this.trigger("change");return this};
...
Space.prototype._set=function(a,b,d){if(!a)return null;a=a.toString().split(/ /g);for(var c=this,e;e=a.shift();)void 0===c.values[e]&&("number"===typeof d?c.keys.splice(d,0,e):c.keys.push(e)),a.length?c.values[e]instanceof Space||(c.values[e]=new Space):c.values[e]=b,c=c.values[e];return this};Space.prototype.set=function(a,b,d){var c=!!this.get(a);this._set(a,b,d);this.trigger("set",a,b,d);c?this.trigger("update",a,b,d):this.trigger("create",a,b,d);this.trigger("change");return this};
...
Space.prototype.trigger=function(a){if(!this.events[a])return!0;var b=Array.prototype.slice.call(arguments),d;for(d in this.events[a])this.events[a][d].apply(this,b.slice(1))};"undefined"!=typeof exports&&(module.exports=Space);
