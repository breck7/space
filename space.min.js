...
Space.prototype.diff=function(a){var b=new Space;a instanceof Space||(a=new Space(a));this.each(function(d){var c=a._getValueByType(d);if("undefined"===typeof c)return b._setPair(d,""),!0;if(typeof this._getValueByType(d)!==typeof c)return"object"===typeof c?b._setPair(d,new Space(c)):this._getValueByType(d)!=c&&b._setPair(d,c),!0;if("object"!==typeof this._getValueByType(d))return this._getValueByType(d)!=c&&b._setPair(d,c),!0;c=this._getValueByType(d).diff(c);c.length()&&b._setPair(d,c)});var c=
