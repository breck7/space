...
Space.prototype.getPath=function(){for(var a=this._parent,b="",c=this,d="";a;)a.each(function(a,f){if(f===c)return b=a+d+b,d=" ",!1}),c=a,a=a._parent;return b};Space.prototype.getRoot=function(){for(var a=this._parent;a._parent;)a=a._parent;return a||this};Space.prototype.getBySpace=function(a){return this._getValueBySpace(a)};Space.prototype._getCachedValue=function(a){return this._values[this._cache[a]]};
