function Space(a){this._pairs=[];this._index={};this._cache={};this.events={};this._load(a);return this}Space.version="0.8.12";Space.removeItems=function(a,b){var c=[];"number"===typeof b&&(b=[b]);for(var d=b.length-1;0<=d;d--)c.push(a.splice(b[d],1));return c};Space.isXPath=function(a){return a.match(/ /)};
