function Space(a){this._pairs=[];this._index={};this._cache={};this.events={};this._load(a);return this}Space.version="0.9.11";Space.removeItems=function(a,b){var c=[];"number"===typeof b&&(b=[b]);for(var d=b.length-1;0<=d;d--)c.push(a.splice(b[d],1));return c};Space.isXPath=function(a){return a.match(/ /)};
...
Space.fromFile=function(a,b,c){if("undefined"===typeof require)throw Error("fromFile only works with node.js");"undefined"===typeof fs&&(fs=require("fs"));"function"===typeof b&&(c=b,b=null);b||(b="utf8");return!c?new Space(fs.readFileSync(a,b)):fs.readFile(a,b,function(a,b){return a?c(a):c(a,new Space(b))})};Space.fromCsv=function(a){return Space.fromDelimiter(a,",")};
Space.fromDelimiter=function(a,b){for(var c=a.length,d="",e=0,f=!1,g=[[]],h=new Space,j=0;e<c;){var l=a[e];f?'"'!==l?d+=l:'"'!==a[e+1]?f=!1:(d+='"',e++):l===b?(g[j].push(d),d="",'"'===a[e+1]&&(f=!0,e++)):"\n"===l?(g[j].push(d),d="",j++,a[e+1]&&(g[j]=[]),'"'===a[e+1]&&(f=!0,e++)):e===c-1?g[j].push(d+l):d+=l;e++}for(c=0;c<g[0].length;c++)g[0][c]=g[0][c].replace(/ /g,"");g.forEach(function(a,b){if(0===b)return!0;var c=new Space;g[0].forEach(function(b,d){var e=a[d];if(""===e)return!0;c.append(b,e)});
h.append(b-1,c)});return h};Space.fromSsv=function(a){return Space.fromDelimiter(a," ")};Space.fromTsv=function(a){return Space.fromDelimiter(a,"\t")};Space._parseXml2=function(a){var b=document.createElement("div");b.innerHTML=a;return b};
...
Space.prototype._deleteByIndex=function(a){if(void 0===this._pairs[a])return 0;var b=this._pairs.splice(a,1),c=b[0][0];this._index[c]--;if(this._index[c]){if(b[0][1]===this._cache[c])for(;0<a;a--)if(this._pairs[a][0]===c){this._cache[c]=this._pairs[a][1];break}}else delete this._cache[c],delete this._index[c];return 1};Space.prototype._deleteByProperty=function(a){a=this.indexOf(a);return-1===a?0:this._deleteByIndex(a)};
...
Space.prototype._getValueBySpace=function(a){var b=new Space,c=this;a.each(function(d){var e=c._getValueByProperty(d);if("undefined"===typeof e)return!0;if(!(a._getValueByProperty(d)instanceof Space)||!a._getValueByProperty(d).length)return b._setPair(d,e),!0;if(!(e instanceof Space))return!0;b._setPair(d,e._getValueBySpace(a._getValueByProperty(d)))});return b};Space.prototype.getValues=function(){var a=[];this._pairs.forEach(function(b){a.push(b[1])});return a};Space.prototype.has=function(a){return!!this._getValueByProperty(a)};
Space.prototype.indexOf=function(a){if(!this._index[a])return-1;for(var b=this.length,c=0;c<b;c++)if(this._pairs[c][0]===a)return c;return-1};Space.prototype.insert=function(a,b,c){this._setPair(a,b,c);return this};Space.prototype.isEmpty=function(){return 0===this.length};Space.prototype.isFlat=function(){for(var a=this.length,b=0;b<a;b++)if(this._pairs[b][1]instanceof Space)return!1;return!0};
Space.prototype.isStringMap=function(a){for(var b=this.length,c={},d=0;d<b;d++){var e=this._pairs[d][0];if(c[e])return!1;c[e]=!0;if(a&&(e=this._pairs[d][1],!(!e instanceof Space)&&!e.isStringMap()))return!1}return!0};Space.prototype.last=function(){if(!this.length)return new Space;var a=this.length-1;return(new Space).set(this._pairs[a][0],this._pairs[a][1])};Space.prototype.lastProperty=function(){return!this.length?null:this._pairs[this.length-1][0]};
Space.prototype.lastValue=function(){return!this.length?null:this._pairs[this.length-1][1]};Object.defineProperty(Space.prototype,"length",{get:function(){return this._pairs.length}});Space._load2=!0;Space.prototype._load=function(a){if("string"===typeof a){if(!a.length)return this;Space._load2?this._loadFromString2(a):this._loadFromString(a);return this}if(a instanceof Space){var b=this;a.each(function(a,d){b._setPair(a,d)});return this}a instanceof Array?this._loadFromArray(a):this._loadFromObject(a)};
Space.prototype._loadFromArray=function(a){for(var b in a)this._loadPair(b.toString(),a[b])};Space.prototype._loadPair=function(a,b){null===b?this._setPair(a,"null"):void 0===b?this._setPair(a,""):"object"!==typeof b?this._setPair(a,b.toString()):b instanceof Date?this._setPair(a,b.getTime().toString()):this._setPair(a,new Space(b))};Space.prototype._loadFromObject=function(a){for(var b in a)Object.prototype.hasOwnProperty.call(a,b)&&this._loadPair(b,a[b])};
Space.prototype._loadFromString2=function(a){for(var b="",c="",d="",e="",f=0,g=0,h={"0":this},j=0,l=0,n=!1,p=a.length,m=0;m<p;m++){var k=a[m];if("\r"!==k&&(n||!("\n"===k||" "===k)))if(n||(n=d=!0),d)" "===k?(d=!1,e=!0,j=f>=g?g:f):"\n"===k?(d=!1,f>=g&&(f=g),g=f+1,h[g]=new Space,h[f]._setPair(b,h[g]),f=0,b=""):b+=k;else if(e)if(l&&" "===k)f++,l--;else if(l)h[j]._setPair(b,c.substr(0,c.length-1)),c="",d=!0,e=!1,b=k,l=0;else if("\n"===k){l=j+1;for(f=0;"\n"===a[m+1];)m++;m!==a.length-1&&(c+=k)}else c+=
...
Space.prototype.map=function(a,b,c,d){if(!d)return(new Space(this)).map(a,b,c);this._index={};this._cache={};for(var e=this._pairs.length,f=0;f<e;f++){var g=this._pairs[f][0];a&&(this._pairs[f][0]=a(g));c&&this._pairs[f][1]instanceof Space?this._pairs[f][1].map(a,b,c,d):b&&(this._pairs[f][1]=b(this._pairs[f][1],this._pairs[f][0],g));this._updateIndexAndCache(this._pairs[f][0],this._pairs[f][1])}return this};Space.prototype.next=function(a){return this._getPropertyByIndex(this.indexOf(a)+1)};
Space.prototype.off=function(a,b){if(!this.events[a])return!0;for(var c in this.events[a])this.events[a][c]===b&&this.events[a].splice(c,1);return this};Space.prototype.on=function(a,b){this.events[a]||(this.events[a]=[]);this.events[a].push(b);return this};
...
Space.prototype._setPair=function(a,b,c,d){a=a.toString();void 0===c?this._pairs.push([a,b]):d&&this._pairs[c]?(d=this._pairs[c][0],this._pairs[c]=[a,b],this._index[d]--,0===this._index[d]&&delete this._cache[d]):c>=this.length?this._pairs.push([a,b]):this._pairs.splice(c,0,[a,b]);this._updateIndexAndCache(a,b,c)};
Space.prototype._updateIndexAndCache=function(a,b,c){var d=this._index[a];if(d)if(void 0===c)this._cache[a]=b;else{for(var e=this.length-1;e>c&&this._pairs[e][0]!==a;e--);e===c&&(this._cache[a]=b)}else this._cache[a]=b;this._index[a]=d?d+1:1};Space.prototype._reindex=function(){var a=this.length;this._index={};this._cache={};for(var b=0;b<a;b++)this._updateIndexAndCache(this._pairs[b][0],this._pairs[b][1],b)};
Space.prototype.shift=function(){if(!this.length)return null;var a=this._getPropertyByIndex(0),b=new Space;b.set(a,this.get(a));this._deleteByIndex(0);return b};Space.prototype.sort=function(a){this._pairs.sort(a);return this};Space.prototype.split=function(a,b){var c=b?new Space:[],d=null;this.each(function(e,f){e===a&&(d&&(b?c.append(b,d):c.push(d)),d=new Space);if(!d)return!0;d.append(e,f)});d&&(b?c.append(b,d):c.push(d));return c};Space.prototype.tableOfContents=function(){return this.getProperties().join(" ")};
...
Space.prototype.trigger=function(a){if(!this.events[a])return this;var b=Array.prototype.slice.call(arguments),c;for(c in this.events[a])this.events[a][c].apply(this,b.slice(1));return this};Space.prototype.trim=function(a){var b=[];this.each(function(c,d,e){d instanceof Space?(a&&d.trim(a),0===d.length&&b.push(e)):d||b.push(e)});Space.removeItems(this._pairs,b);this._reindex();return this};Space.prototype.update=function(a,b,c){this._setPair(b,c,a,!0);return this};
Space.prototype.wrap=function(a){var b=new Space;b.set(a,this);return this.reload(b.toString())};"undefined"!==typeof exports&&(module.exports=Space);
