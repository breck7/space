...
Space.prototype._set=function(a,b,d){if(!a)return null;a=a.toString().split(/ /g);for(var c=this,e;e=a.shift();)void 0===c.values[e]&&("number"===typeof d?c.keys.splice(d,0,e):c.keys.push(e)),a.length?c.values[e]instanceof Space||(c.values[e]=new Space):c.values[e]=b,c=c.values[e];return this};Space.prototype.set=function(a,b,d){var c=!!this.get(a);this._set(a,b,d);c?this.trigger("update",a,b,d):this.trigger("create",a,b,d);return this};
