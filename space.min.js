function Space(a){this._pairs=[];this._propertyCounts={};this._cache={};this._load(a);return this}Space.version="0.9.14";Space.removeItems=function(a,b){var c=[];"number"===typeof b&&(b=[b]);for(var d=b.length-1;0<=d;d--)c.push(a.splice(b[d],1));return c};Space.isXPath=function(a){return a.match(/ /)};
...
Space.prototype._deleteByIndex=function(a){if(void 0===this._pairs[a])return 0;var b=this._pairs.splice(a,1),c=b[0][0];this._propertyCounts[c]--;if(this._propertyCounts[c]){if(b[0][1]===this._cache[c])for(;0<a;a--)if(this._pairs[a][0]===c){this._cache[c]=this._pairs[a][1];break}}else delete this._cache[c],delete this._propertyCounts[c];return 1};Space.prototype._deleteByProperty=function(a){a=this.indexOf(a);return-1===a?0:this._deleteByIndex(a)};
...
Space.prototype.each=function(a){for(var b=this._pairs.length,c=0;c<b&&!1!==a.call(this,this._pairs[c][0],this._pairs[c][1],c);c++);return this};Object.defineProperty(Space.prototype,"events",{get:function(){return this._events||{}}});Space.prototype.every=function(a){this.each(function(b,c,d){a.call(this,b,c,d);c instanceof Space&&c.every(a)});return this};
Space.prototype.filter=function(a){for(var b=new Space,c=this._pairs.length,d=0;d<c;d++)!0===a.call(this,this._pairs[d][0],this._pairs[d][1],d)&&b.append(this._pairs[d][0],this._pairs[d][1]);return b};Space.prototype.find=function(a,b){var c=new Space;this.get(a)===b&&c.push(this);this.each(function(d,e){if(!(e instanceof Space))return!0;e.find(a,b).each(function(a,b){c.push(b)})});return c};Space.prototype.first=function(){return!this.length?new Space:(new Space).set(this._pairs[0][0],this._pairs[0][1])};
Space.prototype.firstProperty=function(){return this.length?this._pairs[0][0]:null};Space.prototype.firstValue=function(){return this.length?this._pairs[0][1]:null};Space.prototype.get=function(a){return void 0===a||null===a?void 0:this._getValueByString(a.toString())};Space.prototype.getAll=function(a){var b=new Space;this.each(function(c,d){if(c!==a)return!0;b.append(c,d)});return b};Space.prototype.getArray=function(a){var b=[];this.each(function(c,d){if(c!==a)return!0;b.push(d)});return b};
...
Space.prototype.map=function(a,b,c,d){if(!d)return(new Space(this)).map(a,b,c);this._propertyCounts={};this._cache={};for(var e=this._pairs.length,f=0;f<e;f++){var g=this._pairs[f][0];a&&(this._pairs[f][0]=a(g));c&&this._pairs[f][1]instanceof Space?this._pairs[f][1].map(a,b,c,d):b&&(this._pairs[f][1]=b(this._pairs[f][1],this._pairs[f][0],g));this._updateIndexAndCache(this._pairs[f][0],this._pairs[f][1])}return this};
Space.prototype.next=function(a){return this._getPropertyByIndex(this.indexOf(a)+1)};Space.prototype.off=function(a,b){if(!this._events||!this._events[a])return this;for(var c in this._events[a])this._events[a][c]===b&&this._events[a].splice(c,1);return this};Space.prototype.on=function(a,b){this._events||(this._events={});this._events[a]||(this._events[a]=[]);this._events[a].push(b);return this};
...
Space.prototype._setPair=function(a,b,c,d){a=a.toString();void 0===c?this._pairs.push([a,b]):d&&this._pairs[c]?(d=this._pairs[c][0],this._pairs[c]=[a,b],this._propertyCounts[d]--,0===this._propertyCounts[d]&&delete this._cache[d]):c>=this.length?this._pairs.push([a,b]):this._pairs.splice(c,0,[a,b]);this._updateIndexAndCache(a,b,c)};
Space.prototype._updateIndexAndCache=function(a,b,c){var d=this._propertyCounts[a];if(d)if(void 0===c)this._cache[a]=b;else{for(var e=this.length-1;e>c&&this._pairs[e][0]!==a;e--);e===c&&(this._cache[a]=b)}else this._cache[a]=b;this._propertyCounts[a]=d?d+1:1};Space.prototype._reindex=function(){var a=this.length;this._propertyCounts={};this._cache={};for(var b=0;b<a;b++)this._updateIndexAndCache(this._pairs[b][0],this._pairs[b][1],b)};
