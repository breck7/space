...
Space.prototype._deleteByIndex=function(a){if(void 0===this._values[a])return 0;this._deleteProperty(a);this._values.splice(a,1);this._reindex();return 1};Space.prototype._deleteByProperty=function(a){a=this.indexOf(a);return-1===a?0:this._deleteByIndex(a)};Space.prototype._deleteBySpacePath=function(a){var b=a.split(/ /);a=b.pop();b=this.get(b.join(" "));return b instanceof Space?b._delete(a):0};Space.prototype._deleteProperty=function(a){this._properties.splice(a,1);return this._getProperties()};
