function Space(a){this._pairs=[];this._index={};this._cache={};this.events={};this._load(a);return this}Space.version="0.9.6";Space.removeItems=function(a,b){var c=[];"number"===typeof b&&(b=[b]);for(var d=b.length-1;0<=d;d--)c.push(a.splice(b[d],1));return c};Space.isXPath=function(a){return a.match(/ /)};
...
Space.prototype.lastProperty=function(){return!this.length?null:this._pairs[this.length-1][0]};Space.prototype.lastValue=function(){return!this.length?null:this._pairs[this.length-1][1]};Object.defineProperty(Space.prototype,"length",{get:function(){return this._pairs.length}});Space._load2=!0;
Space.prototype._load=function(a){if("string"===typeof a){if(!a.length)return this;Space._load2?this._loadFromString2(a):this._loadFromString(a);return this}if(a instanceof Space){var b=this;a.each(function(a,d){b._setPair(a,d)});return this}a instanceof Array?this._loadFromArray(a):this._loadFromObject(a)};Space.prototype._loadFromArray=function(a){for(var b in a)this._loadPair(b.toString(),a[b])};
