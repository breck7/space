...
Space.prototype.everyLeaf=function(a){this._every(a,!0);return this};Space.prototype.filter=function(a,b){if(b)return this._filterInPlace(a);for(var c=new Space,d=this.length,e=this._getProperties(),f=this._getValues(),h=0;h<d;h++)!0===a.call(this,e[h],f[h],h)&&c._append(e[h],f[h]);return c};
