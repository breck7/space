function Space(a){this.keys=[];this.values={};this.events={};this._load(a);return this}Space.pathBranch=function(a){a=a.split(/ /g);if(2>a.length)return"";a.pop();return a.join(" ")};Space.pathLeaf=function(a){var b=a.split(/ /g);return 2>b.length?a:b[b.length-1]};Space.strRepeat=function(a,b){for(var d="",c=0;c<b;c++)d+=" ";return d};
...
Space.prototype.append=function(a,b){this._set(a,b);this.trigger("append",a,b);this.trigger("change");return this};Space.prototype._clear=function(){this.keys=[];this.values={};return this};Space.prototype.clear=function(a){if(this.isEmpty())return this;this._clear();this.trigger("clear");a&&this._load(a);this.trigger("change");return this};Space.prototype.clone=function(){return new Space(this.toString())};
...
Space.prototype.getBySpace=function(a){var b=new Space,d;for(d in a.keys){var c=a.keys[d],e=this.values[c];"undefined"!==typeof e&&(!(a.values[c]instanceof Space)||!a.values[c].keys.length?b._set(c,e):e instanceof Space&&b._set(c,e.getBySpace(a.values[c])))}return b};
Space.prototype.getCharMap=function(a){for(var b=this.toString(),d="K",c="",e=1,f=0,g=0;g<b.length-1;g++){var h=b.substr(g,1);a&&console.log("map: %s; mode: %s; char: %s",c,d,h);0<f?(c+="E",f--):" "!==h&&"\n"!==h?("N"===d&&(d="K"),c+=d):" "===h?"V"===d?c+=d:"K"===d?(c+="S",d="V"):(e++,c+="N"):"K"===d?(d="N",e=1,c+="N"):"V"===d&&(b.substr(g+1,e)===Space.strRepeat(" ",e)?(c+="V",f=e):(d="N",e=1,c+="N"))}return c};Space.prototype.length=function(){return this.keys.length};
