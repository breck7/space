function Space(a){this._properties=[];this._values=[];this._cache={};return this._load(a)}Space.version="0.12.3";Space.removeItems=function(a,b){var c=[];"number"===typeof b&&(b=[b]);for(var d=b.length-1;0<=d;d--)c.push(a.splice(b[d],1));return c};Space.isSpacePath=function(a){return a.match(/ /)};
...
c.length&&b.set("children",c);return b};Space._pairToString=function(a,b,c){a=Space.strRepeat(" ",c)+a;return a=b instanceof Space?a+("\n"+b._toString(c+1)):b.match(/\n/)?a+(" "+b.replace(/\n/g,"\n"+Space.strRepeat(" ",c+1))+"\n"):a+(" "+b+"\n")};
...
Space.prototype._clear=function(){this._properties=[];this._values=[];this._cache={};return this};Space.prototype.clear=function(a){if(this.isEmpty())return this;this._clear();this.trigger("clear");a&&this._load(a);this.trigger("change");return this};Space.prototype.clearListeners=function(a){if(!this._events)return this;if(a)delete this._events[a];else for(a in this._events)this._events.hasOwnProperty(a)&&delete this._events[a];return this};Space.prototype.clone=function(){return new Space(this.toString())};
...
Space.prototype._deleteByIndex=function(a){if(void 0===this._values[a])return 0;this._properties.splice(a,1)[0];this._values.splice(a,1)[0];this._reindex(a);return 1};Space.prototype._deleteByProperty=function(a){a=this.indexOf(a);return-1===a?0:this._deleteByIndex(a)};Space.prototype._deleteBySpacePath=function(a){var b=a.split(/ /);a=b.pop();b=this.get(b.join(" "));return b instanceof Space?b._delete(a):0};
...
Space.prototype.isStringMap=function(a){for(var b=this.length,c={},d,e=0;e<b;e++){d=this._properties[e];if(c[d])return!1;c[d]=!0;if(a&&(d=this._values[e],!(!d instanceof Space)&&!d.isStringMap()))return!1}return!0};Space.prototype.last=function(){if(!this.length)return new Space;var a=this.length-1;return(new Space).set(this._properties[a],this._values[a])};Space.prototype.lastIndexOf=function(a){if(!this.has(a))return-1;for(var b=this.length-1;0<b;b--)if(this._properties[b]===a)return b;return-1};
Space.prototype.lastProperty=function(){return!this.length?null:this._properties[this.length-1]};Space.prototype.lastValue=function(){return!this.length?null:this._values[this.length-1]};Object.defineProperty(Space.prototype,"length",{get:function(){return this._values.length}});Space._load2=!1;
...
Space.prototype._setPair=function(a,b,c,d){if(a=a.toString()){var e=this.length,f=b instanceof Space,g=typeof b;!f&&("object"===g&&b)&&(b=new Space(b),f=!0);"string"!==g&&!f&&(b=String(b));f&&(b._parent=this);void 0===c||c>=e?(this._properties.push(a),this._values.push(b),this._cache[a]=e):(d&&0<=c?(this._properties[c]=a,this._values[c]=b):(this._properties.splice(c,0,a),this._values.splice(c,0,b)),this._reindex(c))}};
Space.prototype._reindex=function(a){var b=this.length;a=a||0;a||(this._cache={});for(;a<b;a++)this._cache[this._properties[a]]=a};Space.prototype.shift=function(){if(!this.length)return null;var a=this._getPropertyByIndex(0),b=new Space;b.set(a,this.get(a));this._deleteByIndex(0);return b};
Space.prototype.sort=function(a){for(var b=[],c=this.length,d=0;d<c;d++)b.push({property:this._properties[d],value:this._values[d]});b.sort(a);this._clear();for(d=0;d<c;d++)this._setPair(b[d].property,b[d].value);return this};Space.prototype.split=function(a,b){var c=b?new Space:[],d=null;this.each(function(e,f){e===a&&(d&&(b?c.append(b,d):c.push(d)),d=new Space);if(!d)return!0;d.append(e,f)});d&&(b?c.append(b,d):c.push(d));return c};Space.prototype.tableOfContents=function(){return this.getProperties().join(" ")};
...
Space.prototype.toQueryString=function(){var a="",b="";this.each(function(c,d){a+=b+encodeURIComponent(c)+"="+encodeURIComponent(d);b="&"});return a};Space.prototype.toSsv=function(){return this.toDelimited(" ")};Space.prototype.toString=function(){return this._toString(0)};Space.prototype._toString=function(a){for(var b="",c=this.length,d=0;d<c;d++)b+=Space._pairToString(this._properties[d],this._values[d],a);return b};Space.prototype.toTsv=function(){return this.toDelimited("\t")};
Space.prototype.toURL=function(){return encodeURIComponent(this.toString())};Space.prototype.toXML=function(a){return this._toXML(a?0:-1)};Space.prototype._toXML=function(a){var b="",c=-1===a?"":Space.strRepeat(" ",a);this.each(function(d,e){b+=c+"<"+d+">";e instanceof Space?0<e.length&&(b+=(-1===a?"":"\n")+e._toXML(-1<a?a+2:-1)+c):b+=e;b+="</"+d+">"+(-1===a?"":"\n")});return b};
Space.prototype.toXMLWithAttributes=function(a){return this.firstValue()._toXMLWithAttributes(this.firstProperty(),a?0:-1)};
