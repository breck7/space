...
Space.prototype._getValueByKey=function(a){var b;this._pairs.forEach(function(c){if(c[0]===a)return b=c[1],!1});return b};Space.prototype._getKeyByIndex=function(a){0>a&&(a=this.length()+a);return this.getKeys()[a]};Space.prototype.getKeys=function(){var a=[];this._pairs.forEach(function(b){a.push(b[0])});return a};Space.prototype._getValueByString=function(a){if(a){if(!a.match(/ /))return this._getValueByKey(a);a=a.split(/ /g);var b=a.shift();if(this.has(b)&&this._getValueByKey(b)instanceof Space)return this._getValueByKey(b).get(a.join(" "))}};
...
Space.prototype.getTokensConcise=function(){return this.getTokens().replace(/[^\w\s]|(.)(?=\1)/gi,"")};Space.prototype.has=function(a){return void 0!==this._getValueByKey(a)};Space.prototype.__height=function(){return this.toString().match(/\n/g).length};Space.prototype.indexOf=function(a){return this.getKeys().indexOf(a)};Space.prototype.insert=function(a,b,c){this._setPair(a,b,c);return this};Space.prototype.isEmpty=function(){return 0===this.length()};
...
Space.prototype._setByXPath=function(a,b){if(!a)return null;for(var c=a.toString().split(/ /g),d=this,e,f,h=0;h<c.length;h++){e=c[h];if(!(d._getValueByKey(e)instanceof Space)){var g;g=h===c.length-1?b:new Space;d.has(e)?(f=d.indexOf(e),d._setPair(e,g,f,!0)):d._setPair(e,g)}d=d.get(e)}return this};Space.prototype._setPair=function(a,b,c,d){a=a.toString();void 0===c?this._pairs.push([a,b]):d?this._pairs.splice(c,1,[a,b]):this._pairs.splice(c,0,[a,b])};
...
Space.prototype.toJavascript=function(a){var b="new Space('"+this.toString().replace(/\n/g,"\\n").replace(/\'/g,"\\'")+"')";return a?b.replace(/\\n/g,"\\n\\\n"):b};Space.prototype.toJSON=function(){return JSON.stringify(this.toObject())};Space.prototype.toObject=function(){var a={};this.each(function(b,c){a[b]=c instanceof Space?c.toObject():c});return a};Space.prototype.toQueryString=function(){var a="",b="";this.each(function(c,d){a+=b+encodeURIComponent(c)+"="+encodeURIComponent(d);b="&"});return a};
