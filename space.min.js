function Space(a){this._pairs=[];this._index={};this._cache={};this.events={};this._load(a);return this}Space.version="0.9.8";Space.removeItems=function(a,b){var c=[];"number"===typeof b&&(b=[b]);for(var d=b.length-1;0<=d;d--)c.push(a.splice(b[d],1));return c};Space.isXPath=function(a){return a.match(/ /)};
...
Space.prototype.every=function(a){this.each(function(b,c,d){a.call(this,b,c,d);c instanceof Space&&c.every(a)});return this};Space.prototype.get=function(a){return void 0===a?void 0:this._getValueByString(a.toString())};Space.prototype.getAll=function(a){var b=new Space;this.each(function(c,d){if(c!==a)return!0;b.append(c,d)});return b};Space.prototype.getArray=function(a){var b=[];this.each(function(c,d){if(c!==a)return!0;b.push(d)});return b};Space.prototype.getByIndex=function(a){return this._getValueByIndex(a)};
...
Space.prototype.getTokens=function(){for(var a=this.toString(),b="K",c="",d=1,e=0,f=a.length,g=0;g<f-1;g++){var h=a.substr(g,1);0<e?(c+="E",e--):" "!==h&&"\n"!==h?("N"===b&&(b="K"),c+=b):" "===h?"V"===b?c+=b:"K"===b?(c+="S",b="V"):(d++,c+="N"):"K"===b?(b="N",d=1,c+="N"):"V"===b&&(a.substr(g+1,d)===Space.strRepeat(" ",d)?(c+="V",e=d):(b="N",d=1,c+="N"))}return c};Space.prototype.getTokensConcise=function(){return this.getTokens().replace(/[^\w\s]|(.)(?=\1)/gi,"")};
...
Space.prototype.push=function(a){for(var b=this.length;this.get(b.toString());)b++;this._setPair(b.toString(),a);return this};Space.prototype._rename=function(a,b){var c=this.indexOf(a);if(-1===c)return this;this._setPair(b,this._getValueByProperty(a),c,!0);return this};Space.prototype.reload=function(a){this._pairs=[];this._index={};this._cache={};this._load(a);this.trigger("reload");return this};
Space.prototype.rename=function(a,b){this._rename(a,b);a!==b&&this.trigger("rename",a,b);this.trigger("change");return this};Space.prototype.renameAll=function(a,b,c){this.each(function(d,e,f){d===a&&this._setPair(b,e,f,!0);c&&e instanceof Space&&e.renameAll(a,b,c)});return this};
Space.prototype.set=function(a,b,c,d){a=a.toString();if(Space.isXPath(a))this._setByXPath(a,b);else{var e=this.indexOf(a);-1<e?this._setPair(a,b,e,!0):this._setPair(a,b,c)}d||(this.trigger("set",a,b,c),this.trigger("change"));return this};
...
Space.prototype._setByXPath=function(a,b){if(!a)return null;for(var c=a.toString().split(/ /g),d=this,e,f,g=c.length,h=0;h<g;h++){e=c[h];if((f=h===c.length-1)||!(d._getValueByProperty(e)instanceof Space)){var j;j=f?b:new Space;d.has(e)?(f=d.indexOf(e),d._setPair(e,j,f,!0)):d._setPair(e,j)}d=d.get(e)}return this};
Space.prototype._setPair=function(a,b,c,d){a=a.toString();void 0===c?this._pairs.push([a,b]):d&&this._pairs[c]?(d=this._pairs.splice(c,1,[a,b])[0][0],this._index[d]--,0===this._index[d]&&delete this._cache[d]):this._pairs.splice(c,0,[a,b]);this._updateCache(a,b,c)};Space.prototype._updateCache=function(a,b,c){var d=this._index[a];if(d){if(void 0!==c){for(var e=0;e<c&&this._pairs[e][0]!==a;e++);e===c&&(this._cache[a]=b)}}else this._cache[a]=b;this._index[a]=d?d+1:1};
...
Space.prototype.toColumns=function(){for(var a=this.toString(),b=[],c=0,d=0,e=0,f=a.length,g=0;g<f;g++){var h=a[g];if("\n"===h){for(;c<d;)b[c]+=" ",c++;c=0;e++}else{if(!b[c]){b[c]="";for(var j=0;j<e;j++)b[c]+=" "}b[c]+=h;c++;c>d&&(d=c)}}return b};Space.prototype.toCsv=function(){return this.toDelimited(",")};
Space.prototype.toDecimalMatrix=function(){for(var a=this.__width(),b=this.toString().replace(/\n$/,"").split(/\n/g),c=[],d=0;d<b.length;d++){for(var e=b[d],f=[],g=e.length,h=0;h<a;h++)h<g?f.push(e.substr(h,1).charCodeAt(0)):f.push(0);c.push(f)}return c};Space.prototype.toDecimalMatrixString=function(){var a="";this.toDecimalMatrix().forEach(function(b){var c="";b.forEach(function(b){a+=c;a=10>b?a+("00"+b):9<b&&100>b?a+("0"+b):a+b;c=" "});a+="\n"});return a};
...
Space.prototype.wrap=function(a){var b=new Space;b.set(a,this);return this.reload(b.toString())};Space.prototype.__width=function(){var a=0;this.toString().split(/\n/g).forEach(function(b){b.length>a&&(a=b.length)});return a};"undefined"!==typeof exports&&(module.exports=Space);
