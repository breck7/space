function Space(a){this._pairs=[];this._index={};this._cache={};this.events={};this._load(a);return this}Space.version="0.9.0";Space.removeItems=function(a,b){var c=[];"number"===typeof b&&(b=[b]);for(var d=b.length-1;0<=d;d--)c.push(a.splice(b[d],1));return c};Space.isXPath=function(a){return a.match(/ /)};
...
Space.fromDelimiter=function(a,b,c){var d=a.length,e="",f=0,h=!1,g=[[]],j=new Space;c=c||"row";for(var l=0;f<d;){var m=a[f];h?'"'!==m?e+=m:'"'!==a[f+1]?h=!1:(e+='"',f++):m===b?(g[l].push(e),e="",'"'===a[f+1]&&(h=!0,f++)):"\n"===m?(g[l].push(e),e="",l++,a[f+1]&&(g[l]=[]),'"'===a[f+1]&&(h=!0,f++)):f===d-1?g[l].push(e+m):e+=m;f++}for(a=0;a<g[0].length;a++)g[0][a]=g[0][a].replace(/ /g,"");g.forEach(function(a,b){if(0===b)return!0;var d=new Space;g[0].forEach(function(b,c){var e=a[c];if(""===e)return!0;
d.append(b,e)});j.append(c,d)});return j};Space.fromSsv=function(a,b){return Space.fromDelimiter(a," ",b)};Space.fromTsv=function(a,b){return Space.fromDelimiter(a,"\t",b)};Space.toFile=function(a,b,c,d,e){if("undefined"===typeof require)throw Error("toFile only works with node.js");"undefined"===typeof fs&&(fs=require("fs"));"function"===typeof c&&(d=c,c=null);return!e&&!d?fs.writeFileSync(a,b.toString(),c):fs.writeFile(a,b.toString(),c,d)};
...
Space.prototype._loadFromString2=function(a){for(var b="",c="",d="",e="",f=0,h=0,g={"0":this},j=0,l=0,m=!1,p=a.length,n=0;n<p;n++){var k=a[n];if("\r"!==k&&(m||!("\n"===k||" "===k)))m||(m=d=!0),d?" "===k?(d=!1,e=!0,j=f>=h?h:f):"\n"===k?(d=!1,f>=h&&(f=h),h=f+1,g[h]=new Space,g[f]._setPair(b,g[h]),f=0,b=""):b+=k:e?l&&" "===k?(f++,l--):l?(g[j]._setPair(b,c.substr(0,c.length-1)),c="",d=!0,e=!1,b=k,l=0):"\n"===k?(l=j+1,f=0,n!==a.length-1&&(c+=k)):c+=k:"\n"!==k&&(" "===k?f++:(d=!0,b=k))}d&&g[f]._setPair(b,
