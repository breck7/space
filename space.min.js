...
Space.prototype.clear=function(){if(this.isEmpty())return this;this.keys=[];this.values={};this.trigger("clear");this.trigger("change");return this};Space.prototype.clone=function(){return new Space(this.toString())};Space.prototype._delete=function(a){if(!a.match(/ /)){var b=this.keys.indexOf(a);if(-1===b)return 0;this.keys.splice(b,1);delete this.values[a];return 1}b=a.split(/ /);a=b.pop();b=this.get(b.join(" "));return b instanceof Space?b._delete(a):0};
