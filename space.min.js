function Space(a){this._clearProperties();this._values=[];this._cache={};return this._load(a)}Space.version="0.16.1";Space._isSpacePath=function(a){return-1<a.indexOf(" ")};Space.fromHeredoc=function(a,b,c){a=a.replace(/\n\r/g,"\n");a=a.split("\n");var d=null,e=[],f=RegExp("^"+b+"(?: |$)"),g=a.length;b=b.length;c=RegExp("^"+c);for(var h=0;h<g;h++)null===d?a[h].match(f)&&(d=h,a[h].length===b&&(a[h]+=" ")):a[h].match(c)?(d=null,e.push(h)):a[h]=" "+a[h];Space._removeItems(a,e);return new Space(a.join("\n"))};
Space.fromCsv=function(a,b){return Space.fromDelimiter(a,",",b)};
Space.fromDelimiter=function(a,b,c){var d=a.length,e="",f='"'===a.substr(0,1),g=f?1:0,h=[[]],j=new Space,l=0;for(c=!1!==c;g<d;){var m=a[g];"\r"!==m&&(f?'"'!==m?e+=m:'"'!==a[g+1]?(f=!1,g+1===d&&h[l].push(e)):(e+='"',g++):m===b?(h[l].push(e),e="",'"'===a[g+1]&&(f=!0,g++)):"\n"===m?(h[l].push(e),e="",l++,a[g+1]&&(h[l]=[]),'"'===a[g+1]&&(f=!0,g++)):g===d-1?h[l].push(e+m):e+=m);g++}var n=h[0];a=n.length;if(c)for(b=0;b<a;b++)n[b]=n[b].replace(/ /g,"");else{n=[];for(b=0;b<a;b++)n.push(b)}h.forEach(function(a,
