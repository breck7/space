...
Space.prototype.set=function(a,b,c){Space.isXPath(a.toString())?this._setByXPath(a,b):this.has(a)?this._setTuple(a,b,this.indexOf(a),!0):this._setTuple(a,b,c);this.trigger("set",a,b,c);this.trigger("change");return this};Space.prototype._setByXPath=function(a,b){if(!a)return null;for(var c=a.toString().split(/ /g),d=this,e,f,g=0;g<c.length;g++){e=c[g];if(!(d._getValueByKey(e)instanceof Space)){var h;h=g===c.length-1?b:new Space;d.has(e)?(f=d.indexOf(e),d._setTuple(e,h,f,!0)):d._setTuple(e,h)}d=d.get(e)}return this};
Space.prototype._setTuple=function(a,b,c,d){void 0===c?this._tuples.push([a,b]):d?this._tuples.splice(c,1,[a,b]):this._tuples.splice(c,0,[a,b])};Space.prototype.shift=function(){if(!this.length())return null;var a=this._getKeyByIndex(0),b=new Space;b.set(a,this.get(a));this._delete(a);return b};Space.prototype.sort=function(a){this._tuples=this._tuples.sort(a);return this};Space.prototype.tableOfContents=function(){return this.getKeys().join(" ")};
