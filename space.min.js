function Space(a){this._clearProperties();this._values=[];this._cache={};return this._load(a)}Space.version="0.18.0";Space._isSpacePath=function(a){return-1<a.indexOf(" ")};Space.fromHeredoc=function(a,b,c){a=a.replace(/\n\r/g,"\n");a=a.split("\n");var d=null,e=[],f=RegExp("^"+b+"(?: |$)"),g=a.length;b=b.length;c=RegExp("^"+c);for(var h=0;h<g;h++)null===d?a[h].match(f)&&(d=h,a[h].length===b&&(a[h]+=" ")):a[h].match(c)?(d=null,e.push(h)):a[h]=" "+a[h];Space._removeItems(a,e);return new Space(a.join("\n"))};
