function Space(a){this._tuples=[];this.events={};this._load(a);return this}Space.version="0.5.1";Space.arrayDelete=function(a,b){return a.slice(0,b).concat(a.slice(b+1))};Space.isXPath=function(a){return a.match(/ /)};Space.pathBranch=function(a){a=a.split(/ /g);if(2>a.length)return"";a.pop();return a.join(" ")};Space.pathLeaf=function(a){var b=a.split(/ /g);return 2>b.length?a:b[b.length-1]};Space.strRepeat=function(a,b){for(var c="",d=0;d<b;d++)c+=" ";return c};
