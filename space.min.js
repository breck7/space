function Space(a){this._properties=[];this._values=[];this._cache={};return this._load(a)}Space.version="0.11.4";Space.removeItems=function(a,b){var c=[];"number"===typeof b&&(b=[b]);for(var d=b.length-1;0<=d;d--)c.push(a.splice(b[d],1));return c};Space.isXPath=function(a){return a.match(/ /)};
