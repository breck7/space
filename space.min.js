function Space(a){this._pairs=[];this._index={};this._cache={};this.events={};this._load(a);return this}Space.version="0.9.10";Space.removeItems=function(a,b){var c=[];"number"===typeof b&&(b=[b]);for(var d=b.length-1;0<=d;d--)c.push(a.splice(b[d],1));return c};Space.isXPath=function(a){return a.match(/ /)};
...
Space.prototype._updateIndexAndCache=function(a,b,c){var d=this._index[a];if(d)if(void 0===c)this._cache[a]=b;else{for(var e=this.length-1;e>c&&this._pairs[e][0]!==a;e--);e===c&&(this._cache[a]=b)}else this._cache[a]=b;this._index[a]=d?d+1:1};Space.prototype.shift=function(){if(!this.length)return null;var a=this._getPropertyByIndex(0),b=new Space;b.set(a,this.get(a));this._deleteByIndex(0);return b};Space.prototype.sort=function(a){this._pairs.sort(a);return this};
...
Space.prototype.trigger=function(a){if(!this.events[a])return this;var b=Array.prototype.slice.call(arguments),c;for(c in this.events[a])this.events[a][c].apply(this,b.slice(1));return this};Space.prototype.update=function(a,b,c){this._setPair(b,c,a,!0);return this};Space.prototype.wrap=function(a){var b=new Space;b.set(a,this);return this.reload(b.toString())};"undefined"!==typeof exports&&(module.exports=Space);
