function Space(a){this._pairs=[];this._index={};this._cache={};this.events={};this._load(a);return this}Space.version="0.9.7";Space.removeItems=function(a,b){var c=[];"number"===typeof b&&(b=[b]);for(var d=b.length-1;0<=d;d--)c.push(a.splice(b[d],1));return c};Space.isXPath=function(a){return a.match(/ /)};
...
Space.prototype._loadFromString2=function(a){for(var b="",c="",d="",e="",f=0,g=0,h={"0":this},j=0,l=0,n=!1,p=a.length,m=0;m<p;m++){var k=a[m];if("\r"!==k&&(n||!("\n"===k||" "===k)))n||(n=d=!0),d?" "===k?(d=!1,e=!0,j=f>=g?g:f):"\n"===k?(d=!1,f>=g&&(f=g),g=f+1,h[g]=new Space,h[f]._setPair(b,h[g]),f=0,b=""):b+=k:e?l&&" "===k?(f++,l--):l?(h[j]._setPair(b,c.substr(0,c.length-1)),c="",d=!0,e=!1,b=k,l=0):"\n"===k?(l=j+1,f=0,m!==a.length-1&&(c+=k)):c+=k:"\n"!==k&&(" "===k?f++:(d=!0,b=k))}d&&h[f]._setPair(b,
new Space);e&&h[j]._setPair(b,c);return this};Space.prototype._loadFromString=function(a){a=a.replace(/^\s*/,"");a=a.replace("\r","");a=a.replace(/\n\n+/,"\n");a=a.split(/\n(?! )/g);var b,c;for(c in a){var d=a[c];(b=d.match(/^([^ ]+)(\n|$)/))?this._setPair(b[1],new Space(d.substr(b[1].length).replace(/\n /g,"\n"))):(b=d.match(/^([^ ]+) /))&&this._setPair(b[1],d.substr(b[1].length+1).replace(/\n /g,"\n"))}return this};
