function Space(a){return this._load(a)}Space.version="0.19.10";Space._isSpacePath=function(a){return-1<a.indexOf(" ")};Space.fromHeredoc=function(a,b,c){a=a.replace(/\n\r/g,"\n");a=a.split("\n");var d=null,e=[],f=RegExp("^"+b+"(?: |$)"),g=a.length;b=b.length;c=RegExp("^"+c);for(var h=0;h<g;h++)null===d?a[h].match(f)&&(d=h,a[h].length===b&&(a[h]+=" ")):a[h].match(c)?(d=null,e.push(h)):a[h]=" "+a[h];Space._removeItems(a,e);return new Space(a.join("\n"))};
Space.fromCsv=function(a,b){return Space.fromDelimiter(a,",",b)};
Space.fromDelimiter=function(a,b,c,d){!1!==d&&-1<a.indexOf("\r")&&(a=a.replace(/\r/g,""));d=[[]];if(-1<a.indexOf('"'))for(var e=a.length,f="",g='"'===a.substr(0,1),h=g?1:0,j,m,l=0,k;h<e;)k=a[h],m=h+1===e,j=a[h+1],isNextCharAQuote='"'===j,g?'"'!==k?f+=k:isNextCharAQuote?(f+=j,h++):(g=!1,m&&d[l].push(f)):k===b?(d[l].push(f),f="",isNextCharAQuote&&(g=!0,h++)):"\n"===k?(d[l].push(f),f="",l++,j&&(d[l]=[]),isNextCharAQuote&&(g=!0,h++)):m?d[l].push(f+k):f+=k,h++;else{e=a.split(/\n/g);f=e.length;for(a=0;a<
f;a++)e[a]&&(d[a]=e[a].split(b))}h=d[0];b=h.length;if(c=!1===c?!1:!0)for(a=0;a<b;a++)h[a]=h[a].replace(/ /g,"");else{h=[];for(a=0;a<b;a++)h.push(a)}b=new Space;e=[];f=[];g={};g.properties=h;h=d.length;j=0;for(a=c?1:0;a<h;a++)c=new Space,c.setWithType(g,d[a]),e.push(j),f.push(c),j++;c={};c.properties=e;c.index=e;b.setWithType(c,f);return b};
...
Space.prototype.getType=function(){if(this._type)return this._type;this._type={properties:this._properties||[]};this._type.index=Space.makeIndex(this._properties);delete this._properties;delete this._index;return this._type};Space.prototype.getTypeIndex=function(){var a={};this.each(function(b,c){if(!(c instanceof Space))return!0;var d=c.getType();void 0===d.key&&(d.key=d.properties.join(" "));var e=a[d.key];e?e&&e!==d&&(c._type=e):a[d.key]=d});return a};
Space.prototype.getUnionType=function(){if(!this.length)return{properties:[]};var a=this.getTypeIndex(),b=Object.keys(a);if(1===b.length)return a[b[0]];for(var a={},c=[],d={properties:c,index:a},b=b.join(" ").split(/ /g),e=b.length,f=0;f<e;f++)void 0===a[b[f]]&&(c.push(b[f]),a[b[f]]=c.length);return d};
...
Space.prototype.set=function(a,b,c,d){a=a.toString();Space._isSpacePath(a)?this._setBySpacePath(a,b):c?this._setPair(a,b,c):this.has(a)?this._setPair(a,b,this.indexOf(a),!0):this._setPair(a,b);d||this.trigger("set",a,b,c).trigger("change");return this};Space.prototype.setType=function(a){if(this._type===a)return this;if(!this._values)return this.setWithType(a);var b=[],c=this;a.properties.forEach(function(a){b.push(c.get(a))});return this.setWithType(a,b)};
...
Space.prototype.toDelimited=function(a,b){var c="",d=RegExp('(\\n|\\"|\\'+a+")"),e=function(a){return!a.match(d)?a:'"'+a.replace(/\"/g,'""')+'"'};b=b||this.getUnionType().properties;b.forEach(function(b){c+=a+e(b)});c=c.substr(1)+"\n";this.each(function(d,g){if(!(g instanceof Space))return!0;var h="";b.forEach(function(b){b=g.get(b)||"";h+=a+e(b.toString())});c+=h.substr(1)+"\n"});return c};
Space.prototype.toArrayWithHeader=function(a){if(!this.length)return[];var b=this._getValues();if(!a&&(this.each(function(b,c){if(a=c instanceof Space&&c.getType())return!1}),!a))return[];for(var c=this.length,d=[a.properties],e=0;e<c;e++)b[e]._type===a&&d.push(b[e]._getValues());return d};Space.prototype.toggle=function(a,b,c){this.get(a)===b?this.set(a,c):this.set(a,b);return this};
