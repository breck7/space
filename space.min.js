function Space(a){this._properties=[];this._values=[];this._cache={};return this._load(a)}Space.version="0.12.2";Space.removeItems=function(a,b){var c=[];"number"===typeof b&&(b=[b]);for(var d=b.length-1;0<=d;d--)c.push(a.splice(b[d],1));return c};Space.isSpacePath=function(a){return a.match(/ /)};
...
Space.prototype.filter=function(a){for(var b=new Space,c=this.length,d=0;d<c;d++)!0===a.call(this,this._properties[d],this._values[d],d)&&b.append(this._properties[d],this._values[d]);return b};Space.prototype.find=function(a,b){var c=new Space;this.get(a)===b&&c.push(this);this.each(function(d,e){if(!(e instanceof Space))return!0;e.find(a,b).each(function(a,b){c.push(b)})});return c};Space.prototype.first=function(){return!this.length?new Space:(new Space).set(this._properties[0],this._values[0])};
Space.prototype.firstProperty=function(){return this.length?this._properties[0]:void 0};Space.prototype.firstValue=function(){return this.length?this._values[0]:void 0};Space.prototype.get=function(a){return void 0===a||null===a?void 0:this._getValueByString(a.toString())};Space.prototype.getAll=function(a){var b=new Space;this.each(function(c,d){if(c!==a)return!0;b.append(c,d)});return b};Space.prototype.getArray=function(a){var b=[];this.each(function(c,d){if(c!==a)return!0;b.push(d)});return b};
Space.prototype.getByIndex=function(a){return this._getValueByIndex(a)};Space.prototype.getBySpace=function(a){return this._getValueBySpace(a)};Space.prototype._getCachedValue=function(a){return this._values[this._cache[a]]};
...
Space.prototype.lastProperty=function(){return!this.length?null:this._properties[this.length-1]};Space.prototype.lastValue=function(){return!this.length?null:this._values[this.length-1]};Object.defineProperty(Space.prototype,"length",{get:function(){return this._values.length}});Space._load2=!0;
...
Space.prototype._setPair=function(a,b,c,d){var e=this.length,f=b instanceof Space;"string"!==typeof b&&!f&&(b=String(b));a=a.toString();void 0===c||c>=e?(this._properties.push(a),this._values.push(b),this._cache[a]=e):(d&&0<=c?(this._properties[c]=a,this._values[c]=b):(this._properties.splice(c,0,a),this._values.splice(c,0,b)),this._reindex(c))};Space.prototype._reindex=function(a){var b=this.length;a=a||0;a||(this._cache={});for(;a<b;a++)this._cache[this._properties[a]]=a};
