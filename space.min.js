...
Space.prototype.pop=function(){if(!this.length())return null;var a=new Space,b=this._getKeyByIndex(-1),c=this._getValueByKey(b);a.set(b,c);this._delete(b);return a};Space.prototype.prepend=function(a,b){return this._setTuple(a,b,0)};Space.prototype.prev=function(a){a=this.indexOf(a)-1;return this._getKeyByIndex(a)};Space.prototype.push=function(a){for(var b=this.length();this.get(b.toString());)b++;this._setTuple(b.toString(),a);return this};
Space.prototype._rename=function(a,b){var c=this.indexOf(a);this._setTuple(b,this._getValueByKey(a),c,!0);return this};Space.prototype.reload=function(a){this._tuples=[];this._load(a);this.trigger("reload");return this};Space.prototype.rename=function(a,b){this._rename(a,b);a!==b&&this.trigger("rename",a,b);this.trigger("change");return this};
Space.prototype.set=function(a,b,c){Space.isXPath(a.toString())?this._setByXPath(a,b):this.has(a)?this._setTuple(a,b,this.indexOf(a),!0):this._setTuple(a,b,c);this.trigger("set",a,b,c);this.trigger("change");return this};
...
Space.prototype.__transpose=function(a){var b="";this.each(function(c,d){var e=new Space(a.toString());e.every(function(a,b,c){d._getValueByKey(b)&&this._setTuple(a,d._getValueByKey(b),c,!0)});b+=e.toString()});return new Space(b)};Space.prototype.trigger=function(a){if(!this.events[a])return!0;var b=Array.prototype.slice.call(arguments),c;for(c in this.events[a])this.events[a][c].apply(this,b.slice(1))};Space.prototype.update=function(a,b,c){this._setTuple(b,c,a,!0);return this};
