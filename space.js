...
Space.prototype.clearKeys = function () {
  this.keys = []
}
...
Space.prototype.deleteKeyByIndex = function (index) {
  this.keys.splice(index, 1)
}

Space.prototype.deleteValueByKey = function (key) {
